...
export function validateOptionNames(positionalArgDefs: ArgumentDefinition[]): ValidationException[] {
  const optionNames = positionalArgDefs.map((positionalArgDef, i) => toOptionName(positionalArgDef, i));
